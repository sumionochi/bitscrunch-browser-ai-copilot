...
const NftAnalytics: React.FC<NftAnalyticsProps> = ({
  ...
  const updSeq = (
    name: SequentialTaskStatus["name"],
  ...
  const fetchAnalytics = useCallback(async () => {
    ...
    try {
      const res = await axios.get(
        "https://api.unleashnfts.com/api/v2/nft/analytics",
        { params, headers: { "x-api-key": apiKey } }
      );
      const data: AnalyticsData = Array.isArray(res.data.data)
        ? res.data.data[0]
        : res.data.data;
  ...
  const fetchWashtrade = useCallback(async () => {
    ...
    try {
      const res = await axios.get(
        "https://api.unleashnfts.com/api/v2/nft/washtrade",
        { params, headers: { "x-api-key": apiKey } }
      );
      const data: WashtradeData = Array.isArray(res.data.data)
        ? res.data.data[0]
        : res.data.data;
      setWashtrade(data);
  ...
  const fetchOwner = useCallback(async () => {
    ...
    try {
      const res = await axios.get(
        "https://api.unleashnfts.com/api/v2/nft/owner",
        { params, headers: { "x-api-key": apiKey } }
      );

      // response is an *array* of owners; you kept only the first
      const data: OwnerData = Array.isArray(res.data.data)
        ? res.data.data[0]
        : res.data.data;
  ...
  const fetchScores = useCallback(async () => {
    ...
    try {
      const res = await axios.get(
        "https://api.unleashnfts.com/api/v2/nft/scores",
        { params, headers: { "x-api-key": apiKey } }
      );
      const data: ScoresData = Array.isArray(res.data.data)
        ? res.data.data[0]
        : res.data.data;
      setScores(data);
  ...
  return (
    <Fragment>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-2 bg-pink-100 p-4 border-4 border-black">
              ...
              <p className="text-3xl font-black">{Number(analytics.assets) || 0}</p>
              {analytics.assets_change !== null && (
                <p
                  className={`text-sm font-bold ${
                    Number(analytics.assets_change) >= 0
                      ? "text-green-600"
                      : "text-red-600"
                  }`}
                >
            ...
            <div className="space-y-2 bg-orange-100 p-4 border-4 border-black">
              ...
              <p className="text-3xl font-black">{Number(analytics.sales) || 0}</p>
              {analytics.sales_change !== null && (
                <p
                  className={`text-sm font-bold ${
                    Number(analytics.sales_change) >= 0
                      ? "text-green-600"
                      : "text-red-600"
                  }`}
                >
            ...
            <div className="space-y-2 bg-indigo-100 p-4 border-4 border-black">
              ...
              <p className="text-3xl font-black">{Number(analytics.transactions) || 0}</p>
              {analytics.transactions_change !== null && (
                <p
                  className={`text-sm font-bold ${
                    Number(analytics.transactions_change) >= 0
                      ? "text-green-600"
                      : "text-red-600"
                  }`}
                >
            ...
            <div className="space-y-2 bg-teal-100 p-4 border-4 border-black">
              ...
              <p className="text-3xl font-black">{Number(analytics.transfers) || 0}</p>
              {analytics.transfers_change !== null && (
                <p
                  className={`text-sm font-bold ${
                    Number(analytics.transfers_change) >= 0
                      ? "text-green-600"
                      : "text-red-600"
                  }`}
                >
      ...
      <Card className="bg-white border-4 border-black p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all">
        <CardContent>
          <h2 className="text-xl font-black mb-4">Wash-trade Metrics</h2>
            ...
            return (
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-2 bg-red-100 p-4 border-4 border-black">
                  ...
                  <p className="text-3xl font-black">
                    {n(washtrade?.washtrade_suspect_sales)}
                  </p>
                  {washtrade?.washtrade_suspect_sales_change != null && (
                    <p
                      className={`text-sm font-bold ${
                        n(washtrade.washtrade_suspect_sales_change) >= 0
                          ? "text-green-600"
                          : "text-red-600"
                      }`}
                    >
                      {(n(washtrade.washtrade_suspect_sales_change) * 100).toFixed(2)}
                      % change
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-2 bg-yellow-100 p-4 border-4 border-black">
                  <h3 className="font-black text-lg">Wash-trade Volume</h3>
                  <p className="text-3xl font-black">
                    ${n(washtrade?.washtrade_volume).toFixed(2)}
                  </p>
                  {washtrade?.washtrade_volume_change != null && (
                    <p
                      className={`text-sm font-bold ${
                        n(washtrade.washtrade_volume_change) >= 0
                          ? "text-green-600"
                          : "text-red-600"
                      }`}
                    >
                ...
                <div className="space-y-2 bg-green-100 p-4 border-4 border-black">
                  ...
                  <p className="text-3xl font-black">
                    {n(washtrade?.washtrade_suspect_transactions)}
                  </p>
                  {washtrade?.washtrade_suspect_transactions_change != null && (
                    <p
                      className={`text-sm font-bold ${
                        n(washtrade.washtrade_suspect_transactions_change) >= 0
                          ? "text-green-600"
                          : "text-red-600"
                      }`}
                    >
                      {(
                        n(washtrade.washtrade_suspect_transactions_change) * 100
                      ).toFixed(2)}
                      % change
                    </p>
                  )}
                ...
                <div className="space-y-2 bg-blue-100 p-4 border-4 border-black">
                  <h3 className="font-black text-lg">Wash-trade Wallets</h3>
                  <p className="text-3xl font-black">
                    {n(washtrade?.washtrade_wallets)}
                  </p>
                  {washtrade?.washtrade_wallets_change != null && (
                    <p
                      className={`text-sm font-bold ${
                        n(washtrade.washtrade_wallets_change) >= 0
                          ? "text-green-600"
                          : "text-red-600"
                      }`}
                    >
      ...
      <Card className="bg-white border-4 border-black p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all">
        <CardContent>
          <h2 className="text-xl font-black mb-4">Owner Information</h2>
          ...
          {(() => {
            ...
            return (
              <div className="grid grid-cols-2 gap-6">
                {/* Current owner */}
                <div className="space-y-2 bg-purple-100 p-4 border-4 border-black">
                  <h3 className="font-black text-lg">Current Owner</h3>
                  <p className="text-3xl font-black">{n(owner?.owner)}</p>
                  {owner?.owner_change != null && (
                    <p
                      className={`text-sm font-bold ${
                        owner.owner_change >= 0
                          ? "text-green-600"
                          : "text-red-600"
                      }`}
                    >
                ...
                <div className="space-y-2 bg-orange-100 p-4 border-4 border-black">
                  ...
                  <p className="text-3xl font-black">{n(owner?.past_owners_count)}</p>
                </div>

                {/* Hold duration */}
                <div className="space-y-2 bg-pink-100 p-4 border-4 border-black">
                  <h3 className="font-black text-lg">Hold Duration (days)</h3>
                  <p className="text-3xl font-black">{n(owner?.hold_duration)}</p>
                </div>
                ...
                <div className="space-y-2 bg-indigo-100 p-4 border-4 border-black">
                  ...
                  <p className="text-lg font-bold">
                    {owner?.max_date
                      ? new Date(owner.max_date).toLocaleDateString()
                      : "N/A"}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-2 bg-yellow-100 p-4 border-4 border-black">
              ...
              <div className="space-y-1">
                <p className="text-sm font-bold">
                  Current: ${Number(scores?.price || 0).toFixed(2)}
                </p>
                <p className="text-sm font-bold">
            ...
            <div className="space-y-2 bg-green-100 p-4 border-4 border-black">
              ...
              <p className="text-3xl font-black">
                {Number(scores?.rarity_score || 0).toFixed(2)}
              </p>
              <p className="text-sm font-bold">
                Rank: #{Number(scores?.rarity_rank || 0)}
              </p>
            </div>
            ...
            <div className="space-y-2 bg-blue-100 p-4 border-4 border-black">
              ...
              <p className="text-lg font-bold">
                Ceiling: ${Number(scores?.price_ceiling || 0).toFixed(2)}
              </p>
            </div>
