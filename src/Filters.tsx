...
import MetricSelect from "../src/components/MetricSelect"
...
const Filters: React.FC<FiltersProps> = ({
  ...
  return (
    <div className="bg-teal-100 mb-4 mt-4 p-4 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all relative z-40">
